...
public abstract class PluginEntry
{
    ...
    protected static int Native_Meta_Query(nint interfaceVersion, nint plinfo, nint pMetaUtilFuncs)
    {
        ...
        InterfaceVersion ifver = ParseInterfaceVersion(version);
    ...
    /// <summary>
    /// Parses the interface version string into an enum value.
    /// </summary>
    private static InterfaceVersion ParseInterfaceVersion(string version) => version switch
    {
